...
**Note**: Similar content exists in welcome-message.md (user welcome message) and this skill's README.md (documentation). This duplication is INTENTIONAL - each file serves a different purpose:
...
- **`../../README.md`**: Human-readable documentation for this skill (upstream mapping, adaptations, sync)
